...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      <div
        className={`fixed top-0 left-0 max-w-[292px] h-full bg-white shadow-lg p-4 transform transition-transform duration-300 ease-in-out ${
          ...
          <ul className="space-y-4">
            <li>
              <NavLink
                to="/profiledashboard"
                className={({ isActive }) =>
                  `flex fs-[16px] items-center space-x-2 px-4 py-2 text-grey rounded-md transition-colors duration-300 ${
                    isActive
                      ? "text-[#0EABEB]"
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex fs-[16px] items-center space-x-2 px-4 py-2 text-grey rounded-md transition-colors duration-300 ${
                    isActive
                      ? "text-[#0EABEB]"
                      : "text-gray hover:text-[#0EABEB] :bg-[#b6dceb]"
                  }`
                }
              >
                <FaUserMd />
